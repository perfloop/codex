#!/usr/bin/env python3
"""Convert the initial-walk Divan result into one proof JSONL sample."""

import json
import re
import sys

BENCHMARK_NAME = "initial_walk_completion_pair"
...
def main() -> None:
    ...
    print(json.dumps({"metric": "initial_walk_completion_ns", "value": value}))
